# from qd_track https://github.com/SysCV/qdtrack/blob/c5b10472d7bdd3b9ab75255dd10e48e21f48c54f/qdtrack/models/losses/multipos_cross_entropy_loss.py
...
class MultiPosCrossEntropyLoss(nn.Module):
    ...
    def forward(self,
                ...
                **kwargs):
        assert cls_score.size() == label.size(), f"classifier score size {cls_score.size()} != label size {label.size()}"
