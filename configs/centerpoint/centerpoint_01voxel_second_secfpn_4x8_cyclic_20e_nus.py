...
# TODO: Extend it by the radar data? Unless the stuff in _base_ already includes the Radar pointcloud data
train_pipeline = [
    dict(
...
# db_sampler = dict(
#     data_root=data_root,
#     info_path=data_root_pkl + 'bevdetv2-nuscenes_dbinfos_train.pkl',
#     rate=1.0,
#     prepare=dict(
