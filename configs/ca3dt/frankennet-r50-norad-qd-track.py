...
train_pipeline = [
    ...
    dict(
        type='Collect3D', keys=['img_inputs', 'points', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_bboxes_3d_ref', 'gt_labels_3d_ref', 'gt_match_indices', 'instance_ids_key', 'instance_ids_ref'])
]
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3D', keys=['points', 'img_inputs', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_bboxes_3d_ref', 'gt_labels_3d_ref', 'gt_match_indices', 'instance_ids_key', 'instance_ids_ref'])
        ])
]
...
model = dict(
    ...
    track_head=dict(
        ...
        #     assigner=dict(
        #         type='MaxIoUAssigner', # TODO modify this to use Rotated BEV Assigner
        #         pos_iou_thr=0.7,
        #         neg_iou_thr=0.3,
        #         min_pos_iou=0.5,
